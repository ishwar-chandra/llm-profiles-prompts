...
flowchart TD
    ...
    Update --> Rules[Update .augment-guidelines if needed]
...
flowchart TD
    ...
    subgraph Learn [Learning Process]
        ...
        D3[Document in .augment-guidelines]
    end
    
    subgraph Apply [Usage]
        A1[Read .augment-guidelines]
